...
Color greenColor = Colors.green[100]!;
Color blueColor = Colors.blue[200]!;
Color textColor = const Color(0xB5131111).withOpacity(0.5);
Color kscaffoldBackgroundColor = Colors.black;
Color containerBackgroundColor = Colors.grey;
